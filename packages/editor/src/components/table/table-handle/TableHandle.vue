<template>
  <Teleport v-if="state && state.widgetContainer" :to="state.widgetContainer">
    <TableHandleControl
      ...
      :floating-ref="rowPosition.floatingRef"
      :floating-style="rowPosition.style.value"
      :index="state.rowIndex"
      :table-pos="state.blockPos"
      @open-change="onMenuToggle('row', $event)"
    ...
    <TableHandleControl
      ...
      :floating-ref="colPosition.floatingRef"
      :floating-style="colPosition.style.value"
      :index="state.colIndex"
      :table-pos="state.blockPos"
      @open-change="onMenuToggle('column', $event)"
      @drag-start="onColDragStart"
      @drag-end="onDragEnd"
    />
  </Teleport>
</template>
...
import TableHandleControl from './TableHandleControl.vue'
