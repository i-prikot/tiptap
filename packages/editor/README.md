...
| `--tt-shadow-elevated-md`   | Shadows  | CSS shadow     | Elevated surface shadow     | `0px 16px 48px 0px #1118270a, 0px 12px 24px 0px #1118270a, 0px 6px 8px 0px #11182705, |

    0px 2px 3px 0px #11182705` | `0px 16px 48px 0px #00000080, 0px 12px 24px 0px #0000003d, 0px 6px 8px 0px #00000038,
    0px 2px 3px 0px #0000001f` |
