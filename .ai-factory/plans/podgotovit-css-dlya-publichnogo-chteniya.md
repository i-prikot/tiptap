...
## Scope and Decisions
- [ ] Deliver a separate public asset from `@i-prikot/renderer`, not a subset of `@i-prikot/editor/styles.css`: the current editor stylesheet is about 1.58 MB and includes menus, toolbars, selections, drag handles, and other editing-only UI.
