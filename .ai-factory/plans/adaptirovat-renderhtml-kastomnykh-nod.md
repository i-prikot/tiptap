...
- [x] Keep editor parsing and NodeView behavior unchanged. Static-only removal belongs at the `@i-prikot/editor-renderer` document boundary and must not mutate the caller's JSON.
